...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { date: @evento.date, local: @evento.local, texto: @evento.texto, titulo: @evento.titulo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { date: @evento.date, local: @evento.local, texto: @evento.texto, titulo: @evento.titulo } }
